...
<!--Contenido-->
              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Salidas <button class="btn btn-primary" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar</button></h1>
                    ...
                    <div class = "form-group col-lg-6 col-md-6 col-sm-6 col-xs-12"> 
                        ...
                        <div class = "form-group col-lg-6 col-md-6 col-sm-6 col-xs-12"> 
                            <label>Salida:</label>
                            <input type="number" class="form-control" name="salida" id="salida" maxlength="10" placeholder="Entrada" required>
                        </div>
  ...
  ?>
  <script type="text/javascript" src="scripts/tbl_salida.js"></script>
