...
<div class="register-box">
 ...
 <div class="register-box-body">
    ...
    <form method="post">
      ...
      <br>
        ...
        <div class center="col-xs-4">
          <button type="submit" class="btn btn-primary btn-block btn-flat">Preguntas de Seguridad</button>

        </div>
        <br>
      </br>
      <div class center="col-xs-4">
          <button type="submit" class="btn btn-primary btn-block btn-flat">Via Correo Electronico </button>
   ...
   <!--  a href="http://localhost/MayRek_System/index.php"-->
