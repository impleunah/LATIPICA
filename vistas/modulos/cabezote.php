			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown user-menu">
					...
					<a href="#" class="dropdown-toggle" data-toggle="dropdown">
						...
						<img src="vistas/img/usuario/default/user.png" class="user-image">
              ...
              <li class="user-body">
				...
				<a href="vistas/modulos/cambiarcontra.php" class="btn btn-default btn-flat">Cambiar Contraseña</a>
