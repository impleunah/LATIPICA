            ...
            <div class="row">
              <div class="col-md-12">
                  <div class="box">
                    ...
                    <h1 class="box-header with-border"> Lista de Proveedores </h1>
    ...
    if(event.charCode >= 48 && event.charCode <= 57){
     ...
     return false;        
                    ...
                    <input type="hidden" name="id_proveedor" id="id_proveedor">
                      ...
                      <input type="text" onkeypress='return validaNumericos(event)'class="form-control" name="telefono" id="telefono"maxlength="11" required="">
                       </div>
                       <div class = "form-group col-lg-6 col-md-6 col-sm-6 col-xs-12"> 
                        <label>Direccion </label>
                      <input type="text" class="form-control" name="direccion" id="direccion"maxlength="50" required="">
                       </div>
